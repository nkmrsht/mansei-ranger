...
export default function FAQ() {
  ...
  const faqs = [
    ...
    },
    {
      ...
      answer: "事前見積もりで提示した金額以外の追加料金は一切ございません。万が一、現場で想定外の工事が必要になった場合も、事前にお客様にご説明し、ご了承をいただいてから作業いたします。"
    },
    {
    ...
    },
    {
      ...
      answer: "松戸市を中心に、千葉県内（柏市、流山市、野田市、鎌ヶ谷市等）および東京都の一部エリア（葛飾区、江戸川区等）にお伺いしております。詳細はお気軽にお問い合わせください。"
    },
    {
      question: "保証はありますか？",
